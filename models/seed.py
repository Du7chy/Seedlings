...
class Seed(db.Model):
    ...
    # User through seed inventory
    users = db.relationship('User', secondary='user_seed_inv', back_populates='seeds')
    inventories = db.relationship('SeedInv', back_populates='seed', cascade='all, delete-orphan')
